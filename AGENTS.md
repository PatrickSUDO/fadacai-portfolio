...
- **新倉 starter 結構（H10 偏好，2026-09-14 用戶「可以鬆一點」）**：新倉/非既有領導者一律起手 ≤1.5%，其餘走回檔梯或走強確認後補（CLS 9/8→9/9 即範例）；`priced_in_pct > +100%` 的名字起手 ≤1%、不一次買滿。**是偏好不是硬線**：可違反，但違反時 journal 必標 `⚠️ H10 bypass` 並在 /trade-review 分組計分（H1/H2 證據：新倉貴價買全負、既有領導者加碼全正）
