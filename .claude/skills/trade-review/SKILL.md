...
> 舊 `pe_ratio < 200` 排除條款來自 DDOG 單一反例（A4 −71%、PE 553、事後 +19% α）。兩期影子計分（8/29、9/14）DDOG 連兩期命中（−12.7%、−3～−7%），PE>200 子集 15 筆 100% 命中/α −14.4%，PE<200 63.9%/−1.4%——唯一有訊號的正是被排除的那一段。獨立標的兩期累計 4/8，**不升閘門、維持 display-only**。
